...
#' @param mir_predicted_targets (a list of) mir interaction sources such as targetscan, mircode, etc.
#' @param number_of_genes_to_test a vector of numbers of genes to be tested, e.g. c(250,500)
...
#' mir_predicted_targets = targetscan, number_of_genes_to_test = c(10), folder = NULL)
