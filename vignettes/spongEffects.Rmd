...
```{r, warning=FALSE, message=FALSE}
subtypes.testing.factors <- as.factor(prep_list_METABRIC_spongEffects$METABRIC.meta$CLAUDIN_SUBTYPE)
...
#conf_matrix_random<-plot_confusion_matrices(trained.model = Random.model)
```
