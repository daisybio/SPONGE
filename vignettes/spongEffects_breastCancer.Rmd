...
BRCA.Modules.OE <- enrichment_modules(Expr.matrix = prep_list_tcga_spongEffects$TCGA.expr.tumor, modules = Sponge.modules, bin.size = 100, min.size = 10, max.size = 200, method = "OE")
