...
Note that if you would like to use the BiocParallel package you can simply 
register any parallel foreach backend such as the one used above as follows:
...
```{r, message=FALSE, warning=FALSE, error=FALSE, fig.width = 12, fig.height = 7}
