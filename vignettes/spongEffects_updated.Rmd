...
filtered_network_centralities=filter_ceRNA_network(sponge_effects = train_ceRNA_interactions, Node_Centrality = train_network_centralities, mscor.threshold = 0.01, padj.threshold = 0.1)
```
